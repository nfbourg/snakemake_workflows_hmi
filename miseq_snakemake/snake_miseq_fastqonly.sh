...
workflow_loc="$SCRIPT_DIR/workflow/preprocessing/miseq"
...
snakemake --cores $1 --rerun-incomplete --use-conda --conda-prefix ${workflow_loc}/.snakemake/envs --snakefile ${workflow_loc}/Snakefile.smk ${@:2} --until qc/multiqc.html
